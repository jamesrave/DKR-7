...
procedure kover(x1, y1, x2, y2: Real);
var
...
begin
  ...
  begin
    ...
    kover(x1, y1, x1n, y1n);
    kover(x1n, y1, x2n, y1n);
    kover(x2n, y1, x2, y1n);
    kover(x1, y1n, x1n, y2n);
    kover(x2n, y1n, x2, y2n);
    kover(x1, y2n, x1n, y2);
    kover(x1n, y2n, x2n, y2);
    kover(x2n, y2n, x2, y2)
  end
end;
...
begin
  case key of
    ...
    VK_Add : begin x1-=10; y1+=10; x2+=10; y2-=10 end;
    VK_Subtract: begin x1+=10; y1-=10; x2-=10; y2+=10 end;
